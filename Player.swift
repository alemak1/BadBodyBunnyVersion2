...
class Player: GKEntity{
    ...
    func swapMotionResponderComponen(notification: Notification){
        ...
        print("Changing the motion responder component....")
        
        removeComponent(ofType: MotionResponderComponent.self)
        
        let isPortrait = UIDevice.current.orientation.isPortrait
        
        let motionResponderComponent: MotionResponderComponent = isPortrait ? PortraitMotionResponderComponentX(motionManager: mainMotionManager) : LandscapeMotionResponderComponentX(motionManager: mainMotionManager)
        addComponent(motionResponderComponent)
